<div class="w-full">
    <section class="breadcrumbs relative pb-0">
        ...
        <div class="py-16 lg:py-28 text-center relative">
            <h2 class="text-[#0A3542] uppercase text-2xl font-semibold tracking-wide lg:text-4xl">Visiting</h2>
        </div>
    </section>
        ...
        <div class="px-2 lg:px-5">
            <div class="flex gap-2 flex-wrap justify-between w-full items-end">
                <div class="w-full max-w-xl pb-2">
                    <p class="mb-1 text-green-600">Welcome to the Magnificent Venue</p>
                    <h2 class="mb-1 text-3xl font-extrabold tracking-wide">Bali, indonesia</h2>
                    <p class="m-0 text-justify"><span class="text-green-600">Bali</span> has
                ...
                <div class="">
                    <a class="text-sm underline hover:text-green-600" href="javascript:void(0)">See more story of Bali
                ...
                <div class="w-full font-normal px-5">
                    ...
                    <div class="flex flex-wrap justify-between p-2 mt-5">
                        ...
                        <button onclick="flight.showModal()"
                            class="font-semibold hover:text-green-600 hover:cursor-pointer hover:underline">Flight time
                            to Bali </button><i class="fa fa-arrows-up-down"></i>
                        <button onclick="electric.showModal()"
                            class="font-semibold hover:text-green-600 hover:cursor-pointer hover:underline">Electric
                            Current </button><i class="fa fa-arrows-up-down"></i>
                        <button
                            class="font-semibold hover:text-green-600 hover:cursor-pointer hover:underline">Conference
                            Venue </button>
                    </div>
