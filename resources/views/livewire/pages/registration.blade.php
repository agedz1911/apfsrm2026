<div class="w-full">
    <section class="breadcrumbs relative pb-0">
        ...
        <div class="py-16 lg:py-28 text-center relative">
            <h2 class="text-[#0A3542] uppercase text-2xl font-semibold tracking-wide lg:text-4xl">Registration</h2>
        </div>
    </section>
    ...
    <section class="pt-10 pb-24 px-2 lg:px-5 bg-competition">
        ...
        <div class="tabs tabs-border justify-evenly">
                ...
                <div class="pb-6 text-gray-500">
                    ...
                    <div class="relative overflow-x-auto shadow sm:rounded-lg ">
                        ...
                        <div class="relative mt-2">
                            <a href="https://expo2.virconex-id.com/registration/apfsrm2026/"
            ...
            <input type="radio" name="my_tabs_2" class="tab uppercase text-lg text-green-700 "
        ...
        <div class=" mt-10">
            <div class="text-center lg:text-start">
                <h2 class="mb-2 uppercase text-3xl font-semibold">Registration
                    <span class="text-green-600">information</span>
                </h2>
            </div>
