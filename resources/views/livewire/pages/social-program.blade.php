<div class="w-full">
    <section class="breadcrumbs relative pb-0">
        ...
        <div class="py-16 lg:py-28 text-center relative">
            <h2 class="text-[#0A3542] uppercase text-2xl font-semibold tracking-wide lg:text-4xl">Social Program</h2>
        </div>
    </section>
    ...
    <section class="pb-24 pt-10">
        <div class="px-2 lg:px-5">
            <div class="flex gap-2 flex-wrap w-full justify-around">
                ...
                <label for="{{$tour->id}}" class="hover:shadow-xl hover:cursor-pointer">
                    <div class="card w-full max-w-sm shadow-sm rounded-lg">
                        ...
                        <div class="card-body">
                            {{-- <span class="badge badge-xs bg-green-700 text-white">Kategori</span> --}}
            ...
            <div class="w-full flex justify-center mt-5">
                <div class="badge badge-soft badge-success w-full max-w-4xl rounded-lg h-full md:p-2">
                    <div>
                        <p class="text-black">For further information, please contact: </p>
                        <div class="flex justify-between pt-2">
                            <a href="https://wa.me/+62081337314000" class="hover:underline hover:text-green-950">
                                <i class="fa fa-whatsapp"></i> 0813-3731-4000
                                <p>Sudi</p>
                            </a>
                            <a href="htts://wa.me/+6281223674000" class="hover:underline hover:text-gray-950">
